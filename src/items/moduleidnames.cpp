...
const QString ModuleIDNames::FullPlusBreadboardModuleIDName = "Breadboard-RSR03MB102-ModuleID";
const QString ModuleIDNames::RectanglePCBModuleIDName = "RectanglePCBModuleID";
const QString ModuleIDNames::TwoSidedRectanglePCBModuleIDName = "TwoLayerRectanglePCBModuleID";
const QString ModuleIDNames::EllipsePCBModuleIDName = "EllipsePCBModuleID";
const QString ModuleIDNames::TwoSidedEllipsePCBModuleIDName = "TwoLayerEllipsePCBModuleID";
...
const QString ModuleIDNames::PowerLabelModuleIDName = "PowerLabelModuleID";
...
const QString ModuleIDNames::Copper0LogoImageModuleIDName = "Copper0LogoImageModuleID";
const QString ModuleIDNames::SchematicLogoTextModuleIDName = "SchematicLogoTextModuleID";
const QString ModuleIDNames::SchematicLogoImageModuleIDName = "SchematicLogoImageModuleID";
const QString ModuleIDNames::BreadboardLogoTextModuleIDName = "BreadboardLogoTextModuleID";
const QString ModuleIDNames::BreadboardLogoImageModuleIDName = "BreadboardLogoImageModuleID";
const QString ModuleIDNames::BoardLogoImageModuleIDName = "BoardLogoImageModuleID";
const QString ModuleIDNames::OneLayerBoardLogoImageModuleIDName = "OneLayerBoardLogoImageModuleID";
const QString ModuleIDNames::PanelBoardModuleIDName = "PanelBoardModuleID";
const QString ModuleIDNames::HoleModuleIDName = "HoleModuleID";
const QString ModuleIDNames::ViaModuleIDName = "ViaModuleID";
const QString ModuleIDNames::PadModuleIDName = "PadModuleID";
const QString ModuleIDNames::Copper0PadModuleIDName = "Copper0PadModuleID";
...
const QString ModuleIDNames::ColorFluxLEDModuleIDName = "LEDSuperfluxModuleID";
